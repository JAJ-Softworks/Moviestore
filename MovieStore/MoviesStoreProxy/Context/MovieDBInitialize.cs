...
namespace MoviesStoreProxy.Context
{
    public class MovieDBInitialize : DropCreateDatabaseAlways<MovieStoreContext>
    {
        ...
        protected override void Seed(MovieStoreContext context)
        {
            ...
            Genre g1 = context.Genres.Add(new Genre() { Id = 3, Name = "Romance" });
            Genre g2 = context.Genres.Add(new Genre() { Id = 1, Name = "Action" });
            Genre g3 = context.Genres.Add(new Genre() { Id = 2, Name = "Horror" });
            Genre g4 = context.Genres.Add(new Genre() { Id = 3, Name = "Romance" });

            context.Movies.Add(new Movie() { Id = 1, Price = 102, Genre = g1, Title = "Taken 3", Year = 2013, ImageUrl = "", TralierUrl = "" });
            context.Movies.Add(new Movie() { Id = 2, Price = 103, Genre = g1, Title = "Terminator 4", Year = 2014, ImageUrl = "", TralierUrl = "" });
